...
module.exports = {
    ...
    detailPage: async (req, res) => {
        try {
            ...
            .select('_id name status category thumbnail')       // pilih id name status category thumbnail saja
            .populate('category')
            .populate('nominals')
    ...
    }, // untuk halaman yang menampilkan pilih kategori di sign up
    ...
    checkout: async (req, res) => {
        try {
            ...
            const payload = {
                ...
                tax,
                value,
                player: req.player._id,         // -> request dari token player
                historyUser: {
    ...
    history: async (req, res) => {
        try {
            ...
            if (req.player._id) {      // request dari token player
                criteria = {
                    ...criteria,
    ...
    dashboard: async (req, res) => {
        try {
            // mengambil id dan total harga tiap kategori
            ...
            // mengambil history lalu diurutkan
